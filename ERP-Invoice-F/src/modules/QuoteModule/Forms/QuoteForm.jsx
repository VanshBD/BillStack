...
function LoadQuoteForm({ subTotal = 0, current = null, form }) {
  ...
  return (
    <div className="invoice-form-container">
      {/* 1. Header Section: Company Info & Quote Meta */}
      <div className="invoice-header-section">
        <div className="invoice-client-info">
          ...
          <label className="invoice-label">{translate('BILL TO')}</label>
          <Form.Item
            name="client"
          ...
          >
            <AutoCompleteAsync
              ...
              placeholder={translate('Search or Select Client')}
            />
          </Form.Item>
          {clientDetails && (
            <div style={{ 
        ...
        <div className="invoice-details-info">
          <Row gutter={16}>
            <Col span={14}>
              <label className="invoice-label">{translate('QUOTE NO.')}</label>
          ...
          <Row gutter={16}>
            <Col span={12}>
              <label className="invoice-label">{translate('DATE')}</label>
              <Form.Item name="date" initialValue={dayjs()} rules={[{ required: true, type: 'object' }]}>
                <DatePicker style={{ width: '100%' }} format={dateFormat} />
              </Form.Item>
            </Col>
            <Col span={12}>
              <label className="invoice-label">{translate('EXPIRE DATE')}</label>
          ...
          <label className="invoice-label">{translate('STATUS')}</label>
      ...
      <div className="invoice-footer-section">
        <div className="invoice-footer-left">
          ...
          <label className="invoice-label"><FileTextOutlined /> {translate('TERMS & CONDITIONS')}</label>
          <Form.Item name="selectedTermsId">
            <Select placeholder={translate('Select Predefined Terms')} onChange={handleTermChange} allowClear>
          ...
          <Form.Item name="termsAndConditions">
            <Input.TextArea rows={4} placeholder={translate('Detailed terms and conditions...')} style={{ borderRadius: '8px' }} />
          </Form.Item>

          <label className="invoice-label">{translate('ADDITIONAL NOTES')}</label>
          <Form.Item name="notes">
            <Input.TextArea rows={2} placeholder={translate('Any notes for the client...')} style={{ borderRadius: '8px' }} />
          </Form.Item>
        </div>
        ...
        <div className="invoice-footer-right">
          ...
          <div className="summary-item total">
            <Title level={4} style={{ margin: 0 }}>{translate('Total')}</Title>
          ...
          <div style={{ marginTop: '16px', padding: '12px', background: '#fff', borderRadius: '8px', border: '1px dashed #cbd5e1', display: 'flex', flexDirection: 'column', gap: '6px' }}>
            <label className="invoice-label" style={{ fontSize: '11px', color: '#64748b', margin: 0 }}>{translate('AMOUNT IN WORDS')}</label>
