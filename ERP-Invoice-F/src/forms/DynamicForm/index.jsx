...
import { DatePicker, Input, Form, Select, InputNumber, Switch, Tag, Space } from 'antd';
  ...
  return (
    <div>
      {Object.keys(fields).map((key) => {
        ...
        if (field.disableForForm || (isUpdateForm && field.disableForUpdate)) return null;
    ...
    return (
      <Form.Item
        ...
        rules={[
          ...
          ...(field.min || field.max ? [{ min: field.min, max: field.max }] : []),
        ]}
