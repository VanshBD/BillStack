...
const secretAccessKey = config.doSpaces.secret;
const accessKeyId = config.doSpaces.key;
const endpoint = config.doSpaces.url ? 'https://' + config.doSpaces.url : undefined;
const region = config.doSpaces.region;
