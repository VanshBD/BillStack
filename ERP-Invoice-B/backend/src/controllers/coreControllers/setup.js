...
const setup = async (req, res) => {
  ...
  for (const filePath of settingsFiles) {
    ...
    const settingsToUpdate = {
      billstack_app_email: email,
      billstack_app_company_email: email,
      billstack_app_timezone: timezone,
      billstack_app_country: country,
      billstack_app_language: language || 'en_us',
    };
  ...
  return res.status(200).json({
    success: true,
    result: {},
    message: 'Successfully BILLSTACK App Setup',
  });
};
